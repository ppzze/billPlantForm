...
<div class = "work">
    ...
    <div class="body">
        ...
        <div class="process">
                <ul>
                    <div> <i class="el-icon-success"></i>工序二</div>
                    <li><i class="el-icon-success"></i>使用电动螺丝刀1拧螺丝1</li>
                ...
                <ul>
                    ...
                    <li class="success"><i class="el-icon-success" v-show="ok"><div v-show="!ok" style="border-radius:50%;width:20px;height:20px;color:white;background-color:red;line-height:17px;text-align:center;font-size:16px;padding-left:5px;">x</div></i>使用电动螺丝刀3拧螺丝</li>
