    ...
    <div class="body">
        ...
        <div class="process">
                ...
                <ul>
                    ...
                    <li class="success"><i class="el-icon-success"><div style="border-radius:50%;width:20px;height:20px;color:white;background-color:red;line-height:20px;text-align:center;font-size:16px;padding-left:10px;">x</div></i>使用电动螺丝刀3拧螺丝</li>
