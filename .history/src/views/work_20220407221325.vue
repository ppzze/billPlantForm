<template>
  <div class="work">
    ...
    <div class="body">
      ...
      <div class="showzhang"  id="model" ref="Model">
        <ul>
          <li :key="guzhang" v-for="guzhang in this.GongXuError">
            <img style="width: 22px; height: 22px;margin-right:30px" src="./img/redcircle.png" />
            {{ guzhang}}
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    exit(){
      ...
      let resexit = this.$http.post(`/proline/station/logOut`, {
