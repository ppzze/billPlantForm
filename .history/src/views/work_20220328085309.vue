    ...
    <div class="body">
        ...
        <div class="process">
                ...
                <ul>
                  ...
                  <!-- 下面是循环生成li -->
                  <ul>
                    <li :key=gongxu v-for="gongxu in paper">
                      <img style="width:22px;height:22px" src="./icon/blue-circle.png" class="GongXUState">
                      {{gongxu.word}}</li>
                  </ul>
<!-- 循环生成li结束 -->
        </div> 
...
methods:{
  changeImg(){
     var obj = document.getElementsByClassName('GongXUState');
     if (this.gongxu.do =='yes'){
        obj.src = './icon/right.png';
     }
     else if(this.gongxu.do =='no'){
       obj.src = './icon/error.png';
     }
     else if(this.gongxu.do =='prepare'){
       obj.src = './icon/blue-circle.png';
     }
  },
}
}
