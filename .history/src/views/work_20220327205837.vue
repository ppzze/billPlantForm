...
<div class = "work">
    ...
    <div class="body">
        ...
        <div class="process">
                <ul>
                    <div> <img style="width:14px;height:14px" :src="this.state==1? require('./icon/blue-circle.png'):require('./icon/grey-circle.png')" > 工序二</div>
                    <li> <img style="width:14px;height:14px" src="./icon/blue-circle.png"> 使用电动螺丝刀1拧螺丝1</li>
