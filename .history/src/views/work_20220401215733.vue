<template>
  <div class="work">
    ...
    <div class="body">
      <div class="zhang" @click="showZhang" v-show="zhanshi" id="menu">障</div>
      <div class="showzhang" v-if="xianshi" id="model">
        <ul>
      ...
      <div class="process">
        <ul>
          ...
          <li class="doing">
            <i class="el-icon-success"></i>使用电动螺丝刀2拧螺丝2
          </li>
        ...
        <ul>
          ...
          <li class="success">
            <i class="el-icon-success"></i>使用电动螺丝刀1拧螺丝1
          </li>
          <li class="success">
            <i class="el-icon-success"></i>使用电动螺丝刀2拧螺丝2
          </li>
          ...
          <li class="doing">
            <i class="el-icon-success"></i>使用电动螺丝刀3拧螺丝
          </li>
          <li class="doing">
            <i class="el-icon-success"></i>使用电动螺丝刀4拧螺丝
          </li>
          <li><i class="el-icon-success"></i>使用电动螺丝刀5拧螺丝</li>
        </ul>
        <!-- 下面是循环生成li -->
...
dianji(){
  var oMenu = this.ha("menu"),oModel = this.ha("model");
console.log('hihihi',oMenu)
oMenu.addEventListener('click', function (e) {
            this.stopFunc(e);
            oModel[0].style.display = "block";
        }, false)
