<template>
  <div class="work">
    ...
    <div class="body">
      <div class="zhang" @click="showZhang" v-show="zhanshi">障</div>
...
<script>
var oMenu = document.getElementsByClassName("zhang")[0];
var oModel = document.getElementsByClassName("showzhang")[0];
